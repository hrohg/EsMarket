...
{
    public class LayoutUpdateStrategy : IExtendedLayoutUpdateStrategy
    {
        ...
        public bool BeforeInsertAnchorable(LayoutRoot layout, LayoutAnchorable anchorableToShow, ILayoutContainer destinationContainer)
        {
            ...
            if (anchorableToShow.CanAutoHide) anchorableToShow.ToggleAutoHide();
            return true;
        }
        public bool BeforeInsertAnchorable(LayoutRoot layout, ExtendedLayoutAnchorable anchorableToShow, ILayoutContainer destinationContainer)
        {
            //AD wants to add the anchorable into destinationContainer
            //just for test provide a new anchorablepane 
            //if the pane is floating let the manager go ahead
