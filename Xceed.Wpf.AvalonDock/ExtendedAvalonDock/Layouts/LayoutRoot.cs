    ...
    public class LayoutRoot : LayoutElement, ILayoutContainer, ILayoutRoot
    {
        ...
        public void RemoveChild(ILayoutElement element)
        {
            if (element == RootPanel)
                RootPanel = null;
            else if (_floatingWindows != null && Xceed.Wpf.AvalonDock.ExtendedAvalonDock.Helpers.Extentions.Contains(_floatingWindows, element))
                _floatingWindows.Remove(element as LayoutFloatingWindow);
            else if (_hiddenAnchorables != null && Xceed.Wpf.AvalonDock.ExtendedAvalonDock.Helpers.Extentions.Contains(_hiddenAnchorables, element))
        ...
        public void ReplaceChild(ILayoutElement oldElement, ILayoutElement newElement)
        {
            ...
            else if (_floatingWindows != null && Xceed.Wpf.AvalonDock.ExtendedAvalonDock.Helpers.Extentions.Contains(_floatingWindows, oldElement))
            {
            ...
            else if (_hiddenAnchorables != null && Xceed.Wpf.AvalonDock.ExtendedAvalonDock.Helpers.Extentions.Contains(_hiddenAnchorables, oldElement))
            {
        ...
        {
            get { return Extentions.GetValueOrDefault<LayoutContent>(_activeContent); }
            set
            {
        ...
        {
            get { return Extentions.GetValueOrDefault<LayoutContent>(_lastFocusedDocument); }
            private set
            {
        ...
        [NonSerialized]
        private ExtendedDocingManager _manager = null;
