...
namespace Zen.Barcode
{
		...
		: BarcodeDrawBase<CodeEan13GlyphFactory, CodeEan13Checksum>
	{
		...
		/// </returns>
        public override BarcodeMetrics GetDefaultMetrics(double maxHeight)
		{
			// TODO: Min bar height should be percentage of max height
			return new BarcodeMetrics1d(0.1, 0.5, maxHeight - 5, maxHeight);
		}
		...
		{
			var maxHeight = desiredBarcodeDimensions.Height * printResolution.Height / 100;
			var minHeight = (maxHeight * 85) / 100;
			var narrowBarWidth = (printResolution.Width * desiredBarcodeDimensions.Width) /
		...
		/// glyphs.
		/// </remarks>
        protected override double GetGlyphHeight(Glyph glyph, double barMinHeight, double barMaxHeight)
		{
		...
		/// <returns></returns>
        protected override double GetDefaultInterGlyphSpace(double barMinWidth, double barMaxWidth)
		{
			return 0;
		}
		#endregion
