...
namespace ES.DataAccess.Models
{
    ...
    {
        public EsStockDbServerEntities()
            : base("name=EsStockDbServerEntities")
        {
        }
        ...
        public virtual DbSet<LogForProducts> LogForProducts { get; set; }
        ...
        public virtual DbSet<Archived_ProductItems> Archived_ProductItems { get; set; }
